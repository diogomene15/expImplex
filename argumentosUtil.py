...
class Args:
    ...
    def carregarArgs(self):
        ...
        if("--inc" in args):
            ...
            self.checarArg(self.inc, "o tamanho inicial dos vetores deve ser um número inteiro > 0")
        else:
        ...
        if("--fim" in args):
            ...
            self.checarArg(self.fim, "o tamanho final dos vetores (fim) deve ser um número inteiro > 0")
        else:
        ...
        if("--stp" in args):
            ...
            self.checarArg(self.stp, "o tamanho de intervalo entre os vetores (stp) deve ser um número inteiro > 0")
        else:
            self.stp = input("Insira o tamanho de intervalo entre os vetores: ")
            self.checarArg(self.stp, "o tamanho de intervalo entre os vetores (stp) deve ser um número inteiro > 0")
        if("--rpt" in args):
            self.rpt = args[args.index("--rpt") + 1]
            self.checarArg(self.rpt, "o numero de repeticoes (rpt) deve ser um número inteiro > 0")
        else:
